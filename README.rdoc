...
* Comes with default commands to load, search, list and install commands and libraries.
...
With the above in irbrc, let's start up irb:
...
See File::Library or here[http://tagaholic.me/boson/doc/classes/Boson/FileLibrary.html].
