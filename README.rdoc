...
* Commands
  * have several layers of options (Boson::OptionParser): global options, rendering options and local options
    specific to the command (Boson::Scientist).
  * can have any view associated to it (via Hirb) without adding view code to the command's method.
    These views can be toggled on and manipulated via global options (Boson::Scientist).
