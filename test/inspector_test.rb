...
module Boson
  class InspectorTest < Test::Unit::TestCase
    ...
    context "commands module" do
      ...
      before(:each) { Inspector.instance_eval "@mod_store[::Boson::Commands::Zzz] = {}" }
